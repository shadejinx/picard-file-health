# File Health — Agent Instructions

## LID
- Mode: Full
- Version: unversioned (no plugin.json/CHANGELOG available in this install; structure matches current linked-intent-dev/arrow-maintenance skill conventions as of 2026-09-06)
...
| Prior session history (pre-LID) | `.omp/HANDOFF.md` — narrative record of past work; gitignored, not part of the arrow, kept locally for archaeology only |
