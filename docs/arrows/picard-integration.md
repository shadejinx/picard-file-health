...
**OK** — fully coherent as of 2026-09-06 (git SHA `5b8d2e44cb567106c32d743bd49e25e17eba4583`). All 21 specs implemented and annotated at their code entry point; every spec has at least one test citing it (27 tests total, some specs covered by more than one). No coverage gaps, no orphan or reverse-orphan spec IDs found.
...
### Tests
- `tests/test_picard_integration.py` (27 tests, using a duck-typed Qt/Picard harness — see Key Findings)
